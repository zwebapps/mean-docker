...
@Component({
  selector: "app-admin-fixture-listing",
  templateUrl: "./admin-fixture-listing.component.html",
  styleUrls: ["./admin-fixture-listing.component.scss"]
})
export class AdminFixtureListingComponent {
